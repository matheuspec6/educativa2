                ...
                <form>
                    <div className="row">
                        <div className="input-field col s11">
                            <select multiple>
                                <option name="disable" value="disable" disabled selected defaultValue>Escolha opção abaixo</option>
                                <option name="CS" value="CS">Faculdade Campos Salles</option>
                                <option name="FPAC" value="FPAC">Faculdade Paulista de Comunicação</option>
                                <option name="outros" value="outros">Outros</option>
                            </select>
                            <label>Escolha a unidade:</label>
                        </div>
                    </div>
                </form>
                                ...
                                <div className="card-content white-text">
                                    ...
                                    <div className="form2 row">
                                        <form className="col s12">
                                            ...
                                            <form className="sexo" onChange={(e) => setSexo(e.target.value)}>
                                                <p className="grey-text lighten-5 text-darken-2 " defaultChecked>Escolha o Sexo:</p>
                                                <label className="tt">
                                                    <input name="Masculino" type="radio" defaultValue="group1" />
                                                    <span>Masculino</span>
                                                </label>
                                                <label className="tt">
                                    ...
                                    <div className="card-action center-align">
                                        <a onClick={Cadastrar} className="btnCadastrar btn-large waves-effect waves-light red lighten-1">Atualizar</a>
                                        <a className="btn-large waves-effect waves-light green darken-2">Aprovar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
